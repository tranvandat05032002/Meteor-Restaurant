  ...
  return (
    <Dialog onOpenChange={(value) => {
      ...
      <DialogContent className='sm:max-w-[600px] max-h-screen overflow-auto' onCloseAutoFocus={() => form.reset()}>
        ...
        <Form {...form}>
          <form noValidate className='grid auto-rows-max items-start gap-4 md:gap-8' id='add-table-form' onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <DialogFooter>
          {/* Thêm id của form để có thể bắt được sự kiện obsubmit ở bên ngoài */}
